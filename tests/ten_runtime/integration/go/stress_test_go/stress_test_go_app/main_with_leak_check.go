...
func (p *defaultApp) OnConfigure(tenEnv ten.TenEnv) {
	tenEnv.LogInfo("=== TEN GC Stress Test App (with leak check) ===")
	...
	tenEnv.LogInfo("Leak check enabled")
	tenEnv.LogInfo("================================")
