...
class test_extension_a : public ten::extension_t {
 public:
  ...
  void on_init(ten::ten_env_t &ten_env) override {
    TEN_LOGI("Extension A on_init: %ld",
...
class test_extension_b : public ten::extension_t {
 public:
  ...
  void on_start(ten::ten_env_t &ten_env) override {
    ...
    thread_2_ = std::thread([ten_env_proxy, this]() {
      ten_random_sleep_range_ms(1000, 2000);
...
TEN_CPP_REGISTER_ADDON_AS_EXTENSION(
    manual_trigger_start_before_init__test_extension_a, test_extension_a);
TEN_CPP_REGISTER_ADDON_AS_EXTENSION(
    manual_trigger_start_before_init__test_extension_b, test_extension_b);

}  // namespace

TEST(ManualTriggerLifeCycleTest, StartBeforeInit) {  // NOLINT
  // Start app.
  auto *app_thread =
  ...
  start_graph_cmd->set_graph_from_json(R"({
    "nodes": [{
        ...
        "addon": "manual_trigger_start_before_init__test_extension_a",
        "extension_group": "a",
        "app": "msgpack://127.0.0.1:8001/"
      },{
        "type": "extension",
        "name": "test_extension_b",
        "addon": "manual_trigger_start_before_init__test_extension_b",
        "extension_group": "b",
        "app": "msgpack://127.0.0.1:8001/",
        "property": {
          "ten": {
