  ...
  void on_start(ten::ten_env_t &ten_env) override {
    ...
    start_graph_cmd->set_graph_from_json(R"({
      "nodes": [{
        ...
        "addon": "stop_graph_during_closing__test_extension_2",
        "app": "msgpack://127.0.0.1:8001/",
        "extension_group": "stop_graph_during_closing__test_extension_2_group"
      }],
      "exposed_messages": [
        {
          "type": "cmd_in",
               ...
               "predefined_graphs": [{
                 ...
                 "graph": {
                   "nodes": [{
                     ...
                     "addon": "stop_graph_during_closing__test_extension_1",
                     "extension_group": "stop_graph_during_closing__predefined_graph_group"
                   }]
                 }
               }]
             }
...
TEN_CPP_REGISTER_ADDON_AS_EXTENSION(stop_graph_during_closing__test_extension_1,
                                    test_extension_1);
TEN_CPP_REGISTER_ADDON_AS_EXTENSION(stop_graph_during_closing__test_extension_2,
                                    test_extension_2);

}  // namespace

TEST(GraphCommunicationTest, StopGraphDuringClosing) {  // NOLINT
