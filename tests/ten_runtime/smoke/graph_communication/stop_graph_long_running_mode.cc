 ...
 public:
  ...
  void on_stop(ten::ten_env_t &ten_env) override {
    TEN_ENV_LOG_INFO(ten_env,
                     "on_stop: test_extension_1 - sending stop_graph command");
    ...
    TEN_ENV_LOG_INFO(
        ten_env,
        "on_stop: test_extension_1 - about to send stop_graph with handler");
    ...
    auto rc = ten_env.send_cmd(
        ...
        [](ten::ten_env_t &ten_env,
           ...
           ten::error_t * /* err */) {
          TEN_ENV_LOG_INFO(ten_env,
                           "✅ on_stop_done: test_extension_1 - "
                           "stop_graph response received!");
    ...
    TEN_ENV_LOG_INFO(
        ten_env,
        "on_stop: test_extension_1 - stop_graph command sent, waiting for "
        "response...");
  }
  ...
  void on_start(ten::ten_env_t &ten_env) override {
    ...
    start_graph_cmd->set_graph_from_json(R"({
      "nodes": [{
        ...
        "addon": "stop_graph_long_running_mode__test_extension_2",
        "app": "msgpack://127.0.0.1:8001/",
        "extension_group": "stop_graph_long_running_mode__test_extension_2_group"
      }],
      "exposed_messages": [
        {
          "type": "cmd_in",
  ...
  void on_cmd(ten::ten_env_t &ten_env,
    ...
    } else if (cmd->get_name() == "trigger_stop_graph") {
      auto cmd_result = ten::cmd_result_t::create(TEN_STATUS_CODE_OK, *cmd);
      ten_env.return_result(std::move(cmd_result));
               ...
               "predefined_graphs": [{
                 ...
                 "graph": {
                   "nodes": [{
                     ...
                     "addon": "stop_graph_long_running_mode__test_extension_1",
                     "extension_group": "stop_graph_long_running_mode__predefined_graph_group"
                   }]
                 }
               }]
             }
...
TEN_CPP_REGISTER_ADDON_AS_EXTENSION(
    stop_graph_long_running_mode__test_extension_1, test_extension_1);
TEN_CPP_REGISTER_ADDON_AS_EXTENSION(
    stop_graph_long_running_mode__test_extension_2, test_extension_2);

}  // namespace

TEST(GraphCommunicationTest, StopGraphLongRunningMode) {  // NOLINT
  ...
  auto stop_graph_cmd = ten::cmd_t::create("trigger_stop_graph");
  stop_graph_cmd->set_dests(
      {{"msgpack://127.0.0.1:8001/", "default", "test_extension_1"}});
  cmd_result = client->send_cmd_and_recv_result(std::move(stop_graph_cmd));
  ten_test::check_status_code(cmd_result, TEN_STATUS_CODE_OK);
