 ...
 public:
  ...
  void on_start(ten::ten_env_t &ten_env) override {
    ...
    start_graph_cmd->set_graph_from_json(R"({
      "nodes": [{
        ...
        "addon": "graph_communication_basic_2__test_extension_2",
        "app": "msgpack://127.0.0.1:8001/",
        "extension_group": "graph_communication_basic_2__test_extension_2_group"
      }],
      "exposed_messages": [
        {
          "type": "cmd_in",
    ...
    ten_env.send_cmd(
        ...
        [](ten::ten_env_t &ten_env,
          ...
          hello_world_cmd->set_dests(
              {{"msgpack://127.0.0.1:8001/", graph_id.c_str(), nullptr}});
          ten_env.send_cmd(
  ...
  void on_cmd(ten::ten_env_t &ten_env,
    ...
    if (cmd->get_name() == "test") {
      ...
      auto graph_id = cmd->get_source().graph_id;
               ...
               "predefined_graphs": [{
                 ...
                 "graph": {
                   "nodes": [{
                     ...
                     "addon": "graph_communication_basic_2__test_extension_1",
                     "extension_group": "graph_communication_basic_2__predefined_graph_group"
                   }]
                 }
               }]
             }
...
TEN_CPP_REGISTER_ADDON_AS_EXTENSION(
    graph_communication_basic_2__test_extension_1, test_extension_1);
TEN_CPP_REGISTER_ADDON_AS_EXTENSION(
    graph_communication_basic_2__test_extension_2, test_extension_2);

}  // namespace

TEST(GraphCommunicationTest, GraphCommunicationBasic2) {  // NOLINT
