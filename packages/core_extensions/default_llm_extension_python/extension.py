...
class DefaultLLMExtension(AsyncASRBaseExtension):
    ...
    async def on_init(self, ten_env: AsyncTenEnv) -> None:
        ...
        ten_env.log_info("DefaultLLMExtension on_init")

        config_json, _ = await self.ten_env.get_property_to_json("")

        try:
            self.config = DefaultLLMConfig.model_validate_json(config_json)
