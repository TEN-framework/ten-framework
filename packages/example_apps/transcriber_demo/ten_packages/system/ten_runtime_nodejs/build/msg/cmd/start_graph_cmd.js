...
export class StartGraphCmd extends Cmd {
     ...
     */
    setPredefinedGraphName(predefinedGraphName) {
        ten_addon.ten_nodejs_cmd_start_graph_set_predefined_graph_name(this, predefinedGraphName);
    }
    /**
     * Set the graph configuration from a JSON string.
     */
    setGraphFromJSON(jsonStr) {
...
//# sourceMappingURL=start_graph_cmd.js.map