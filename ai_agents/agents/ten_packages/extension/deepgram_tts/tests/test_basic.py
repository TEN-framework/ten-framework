...
def test_dump_functionality(MockDeepgramTTSClient):
    ...
    print(f"Dump test passed: received {len(tester.received_audio_chunks)} audio chunks")
...
def test_flush(MockDeepgramTTSClient):
    ...
    assert tester.audio_end_received, "tts_audio_end was not received after flush."
