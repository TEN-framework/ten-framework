...
def test_empty_text(MockDeepgramTTSClient):
    ...
    assert tester.audio_end_received, "tts_audio_end should be sent for empty text."
...
def test_whitespace_text(MockDeepgramTTSClient):
    ...
    assert tester.audio_end_received, "tts_audio_end should be sent for whitespace text."
...
def test_long_text(MockDeepgramTTSClient):
    ...
    assert tester.audio_end_received, "tts_audio_end was not received for long text."
    assert tester.audio_chunks_count > 0, "No audio chunks received for long text."
...
def test_special_characters(MockDeepgramTTSClient):
    ...
    assert not tester.error_received, "Error should not be received for special chars."
