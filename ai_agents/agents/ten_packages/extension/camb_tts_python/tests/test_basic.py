...
@patch("camb_tts_python.extension.CambTTSClient")
def test_dump_functionality(MockCambTTSClient):
    ...
    # --- Mock Configuration ---
    mock_instance = MockCambTTSClient.return_value
    ...
    tester.set_test_mode_single("camb_tts_python", json.dumps(dump_config))
...
class ExtensionTesterFlush(ExtensionTester):
    def __init__(self):
        ...
        self.sample_rate = 24000  # Camb TTS sample rate
...
@patch("camb_tts_python.extension.CambTTSClient")
def test_flush_logic(MockCambTTSClient):
    """
    ...
    tester.set_test_mode_single("camb_tts_python", json.dumps(config))
