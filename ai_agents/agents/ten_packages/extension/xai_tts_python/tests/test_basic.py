...
def test_dump_functionality(MockXAITTSClient):
    ...
    mock_instance = MockXAITTSClient.return_value
    ...
    tester.set_test_mode_single("xai_tts_python", json.dumps(dump_config))
...
@patch("xai_tts_python.extension.XAITTSClient")
def test_basic_audio(MockXAITTSClient):
...
@patch("xai_tts_python.extension.XAITTSClient")
def test_flush(MockXAITTSClient):
