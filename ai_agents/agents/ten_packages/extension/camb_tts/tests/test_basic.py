...
@patch("camb_tts.extension.CambTTSClient")
def test_dump_functionality(MockCambTTSClient):
    ...
    tester.set_test_mode_single("camb_tts", json.dumps(dump_config))
...
def test_flush_logic(MockCambTTSClient):
    ...
    tester.set_test_mode_single("camb_tts", json.dumps(config))
