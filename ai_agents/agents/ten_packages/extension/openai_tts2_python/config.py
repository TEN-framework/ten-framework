...
class OpenAITTSConfig(AsyncTTS2HttpConfig):
    ...
    def update_params(self) -> None:
        ...
        if "enable_session_context" not in self.params:
            self.params["enable_session_context"] = False
        if "enable_request_id" not in self.params:
            self.params["enable_request_id"] = False
