...
class SambertTTSExtension(AsyncTTS2BaseExtension):
    def __init__(self, name: str) -> None:
        super().__init__(name)

        # TTS client for Sam b er t TTS service
        self.client: SambertTTSClient | None = None
        # Configuration for TTS settings
        self.config: SambertTTSConfig | None = None
    ...
    async def on_init(self, ten_env: AsyncTenEnv) -> None:
        try:
            ...
            if self.config is None:
                ...
                self.config = SambertTTSConfig.model_validate_json(config_json)
            ...
            # Initialize Sambert TTS client
            self.client = SambertTTSClient(self.config, ten_env, self.vendor())
            self.client.start()
    ...
    async def request_tts(self, t: TTSTextInput) -> None:
        ...
        try:
            ...
            # Get audio stream from Sambert TTS
            self.ten_env.log_info(
