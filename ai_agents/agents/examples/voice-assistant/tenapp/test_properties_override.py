            ...
            if req_field == "ChannelName":
                for mapping in mappings:
                    if node_name == mapping["ExtensionName"]:
                        old_val = node['property'].get(mapping["Property"], "N/A")
    ...
    for node in nodes:
        ...
        # Show avatar nodes
            ...
            if 'agora_channel_name' in props:
                ...
                results.append((f"{addon}.agora_channel_name", val, channel_name))
...
def test_heygen_properties():
    ...
    print("╔" + "=" * 68 + "╗")
    print("║" + " " * 68 + "║")
    print("║" + "  TEST: voice_assistant_heygen with channel property".center(68) + "║")
    print("║" + " " * 68 + "║")
    print("╚" + "=" * 68 + "╝")
    print("\n")
    ...
    result = simulate_property_override(
        ...
        custom_properties={
            "avatar": {
                "channel": "dynamic_test_channel_123"
            }
        }
    )
...
def test_generic_video_properties():
    ...
    print("╔" + "=" * 68 + "╗")
    print("║" + " " * 68 + "║")
    print("║" + "  TEST: voice_assistant_generic_video with agora_channel_name".center(68) + "║")
    print("║" + " " * 68 + "║")
    print("╚" + "=" * 68 + "╝")
    print("\n")
    ...
    result = simulate_property_override(
        ...
        custom_properties={
            "avatar": {
                "agora_channel_name": "dynamic_test_channel_456"
            }
        }
    )
...
def test_without_custom_properties():
    ...
    print("╔" + "=" * 68 + "╗")
    print("║" + " " * 68 + "║")
    print("║" + "  TEST: Without custom properties (EXPECTED TO FAIL)".center(68) + "║")
    print("║" + " " * 68 + "║")
    print("╚" + "=" * 68 + "╝")
    print("\n")
...
if __name__ == "__main__":
    ...
    print("║" + "  Demonstrates /start API properties parameter".center(68) + "║")
    print("║" + " " * 68 + "║")
    print("╚" + "=" * 68 + "╝")
    ...
    results.append(("voice_assistant_heygen with properties", test_heygen_properties()))

    # Test 2: Generic Video with properties
    results.append(("voice_assistant_generic_video with properties", test_generic_video_properties()))

    # Test 3: Without custom properties (should show the problem)
    results.append(("Without custom properties (shows issue)", test_without_custom_properties()))
