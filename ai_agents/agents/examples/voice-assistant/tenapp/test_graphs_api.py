...
def test_graph_structure(graph_name):
    ...
    if "graph" in graph:
        ...
        if "nodes" in graph_obj:
            ...
            if "heygen" in graph_name or "generic_video" in graph_name:
                ...
                if avatar_nodes:
                    ...
                    if "heygen" in graph_name and addon == "heygen_avatar_python":
                        print(f"✓ Correct avatar extension for HeyGen graph")
                    elif "generic_video" in graph_name and addon == "generic_video_python":
                        print(f"✓ Correct avatar extension for Generic Video graph")
                    else:
        ...
        if "connections" in graph_obj:
            ...
            if "heygen" in graph_name or "generic_video" in graph_name:
                tts_connections = [c for c in connections if c.get("extension") == "tts"]
                if tts_connections:
...
if __name__ == "__main__":
    ...
    results.append(("voice_assistant_heygen", test_graph_structure("voice_assistant_heygen")))
    results.append(("voice_assistant_generic_video", test_graph_structure("voice_assistant_generic_video")))
