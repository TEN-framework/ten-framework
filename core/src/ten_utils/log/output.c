...
void ten_log_set_output_to_file(ten_log_t *self, const char *log_path) {
  ...
  ten_log_set_formatter(self, ten_log_default_json_formatter, NULL);
}
...
void ten_log_set_output_to_stderr(ten_log_t *self) {
  ...
  formatter_func = ten_log_colored_json_formatter;
#else
  formatter_func = ten_log_default_json_formatter;
#endif
