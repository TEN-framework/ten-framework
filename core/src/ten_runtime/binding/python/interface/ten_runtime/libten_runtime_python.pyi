...
class _Cmd(_Msg):
    ...
    def clone_internal(self) -> "_Cmd": ...

class _CmdResult(_Msg):
    def __new__(cls, status_code: int, target_cmd: _Cmd) -> "_CmdResult": ...
    def clone_internal(self) -> "_CmdResult": ...
    def get_status_code_internal(self) -> int: ...
    def set_final_internal(self, is_final_flag: int) -> None: ...
    def is_final(self) -> bool: ...
    def is_completed(self) -> bool: ...

class _Data(_Msg):
    def __new__(cls, name: str) -> "_Data": ...
    def clone_internal(self) -> "_Data": ...
...
class _VideoFrame(_Msg):
    ...
    def clone_internal(self) -> "_VideoFrame": ...
    def alloc_buf(self, size: int) -> None: ...
    def lock_buf(self) -> memoryview: ...
    def unlock_buf(self, buf: memoryview) -> None: ...
    def get_buf(self) -> bytearray: ...
...
class _AudioFrame(_Msg):
    ...
    def clone_internal(self) -> "_AudioFrame": ...
    def alloc_buf(self, size: int) -> None: ...
    def lock_buf(self) -> memoryview: ...
    def unlock_buf(self, buf: memoryview) -> None: ...
    def get_buf(self) -> bytearray: ...
